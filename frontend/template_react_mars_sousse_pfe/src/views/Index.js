...
export default function Index() {
  return (
    <>
      <IndexNavbar fixed />
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px" style={{ background: "transparent" }}>
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-white">
                TRANSFORMEZ VOTRE CORPS , DEPASSEZ VOS LIMITES !
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-300">
                Rejoignez GymAccess et profitez d'équipements modernes, de coachs certifiés et d'un accès 24h/24. Votre transformation commence aujourd'hui.
              </p>
              <div className="mt-12">
                <a
                  href="/inscription"
                  ...
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        GYM ACCESS  comes with a huge number of Fully Coded CSS
                        components.
                      </p>
                    </div>
                  </div>
